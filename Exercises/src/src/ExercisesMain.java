...
public class ExercisesMain {
    ...
    public static void main(String... args){
        ...
        System.out.println("Text generated from ipsum lorum at letter level, 2nd-order is: " + new MarkovGenerator(text, GenerateLevel.Letter).generate());
        System.out.println("Text generated from ipsum lorum at word level, 2nd-order is: " + new MarkovGenerator(text, GenerateLevel.Word).generate());
    }
}
